export default function SectionProcess() {
  return (
    <section>
      <div className="padding-global-2 pt-[11.75rem] pb-[8.25rem]">
          ...
          <div className="grid grid-cols-2 items-start">
            ...
            <div className="ml-5 grid grid-cols-2 gap-5">
              <div className="grid gap-10 pl-8 pr-5 py-10 bg-white rounded-2xl">
                <h3 className="text-5xl font-medium leading-[1.1] -tracking-[0.12rem]">Know</h3>
                <img src="/images/process-know.svg" alt="" className="w-[6.75rem] h-[6.5rem]" />
              ...
              <div className="grid gap-10 pl-8 pr-5 py-10 bg-white rounded-2xl">
                <h3 className="text-5xl font-medium leading-[1.1] -tracking-[0.12rem]">Explore</h3>
                <img src="/images/process-explore.svg" alt="" className="w-[6.38rem] h-[6.38rem]" />
                <p className="text-lg font-normal leading-[1.5]">
              ...
              <div className="grid gap-10 pl-8 pr-5 py-10 bg-white rounded-2xl">
                <h3 className="text-5xl font-medium leading-[1.1] -tracking-[0.12rem]">Build</h3>
                <img src="/images/process-build.svg" alt="" className="w-[5.75rem] h-[6.38rem]" />
                <p className="text-lg font-normal leading-[1.5]">
              ...
              <div className="grid gap-10 pl-8 pr-5 py-10 bg-white rounded-2xl">
                <h3 className="text-5xl font-medium leading-[1.1] -tracking-[0.12rem]">Test</h3>
                <img src="/images/process-test.svg" alt="" className="w-[5.13rem] h-[6.38rem]" />
                <p className="text-lg font-normal leading-[1.5]">
