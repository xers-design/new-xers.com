...
export default function Card({ project, shouldReverse }: { project: Project; shouldReverse: boolean }) {
  return (
    <Link href={`/projects/${project.slug.current}`}>
      ...
      >
        <div className="flex flex-col gap-2 sm:gap-9 max-w-[19.81rem]">
          ...
          <p className="text-lg sm:text-xl font-normal leading-[1.5]">{project.description}</p>
