          ...
          <div className="grid sm:grid-cols-2 gap-10 mt-12 sm:mt-16">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              ...
              <div className="flex flex-col gap-[0.31rem]">
                ...
                <div className="text-black text-xl sm:text-2xl leading-[1.3] font-medium">Confie</div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              ...
              <div className="flex flex-col gap-[0.31rem]">
                ...
                <div className="text-black text-xl sm:text-2xl leading-[1.3] font-medium">Confie.ai</div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              ...
              <div className="flex flex-col gap-[0.31rem]">
                ...
                <div className="text-black text-xl sm:text-2xl leading-[1.3] font-medium">Global</div>
              </div>
            </div>
          </div>
