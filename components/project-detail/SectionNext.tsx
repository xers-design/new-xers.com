...
export default function SectionNext({ project }: { project: ProjectDetail }) {
  return (
    <>
      <section>
        <div className={twm('padding-global', !project.nextProject && 'pb-2 sm:pb-14')}>
          <div className="-mx-4 sm:mx-0">
            ...
            {project.nextProject && (
              <div className="flex justify-center relative -translate-y-1/2 px-10 sm:px-0">
                <Link href={`/projects/${project.nextProject.slug.current}`} className="w-full sm:w-auto">
      ...
      {!project.nextProject && <GetInTouch show={true} />}
    </>
  );
}
